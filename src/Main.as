package
{
	...
	public class Main extends Sprite
	{
		...
		private function initStarling():void
		{
			...
			starlingCheckerboard.showStatsAt("left", "center");
		...
		private function updateRenderDesc():void
		{
			...
			switch (renderOrder)
			{
			case CHECKERS_CUBES_STARS: 
				txt += "Render Order (first:behind to last:in-front) : Checkers > Cubes > Stars";
				break;
			case STARS_CHECKERS_CUBES: 
				txt += "Render Order (first:behind to last:in-front) : Stars > Checkers > Cubes";
				break;
			case CUBES_STARS_CHECKERS: 
				txt += "Render Order (first:behind to last:in-front) : Cubes > Stars > Checkers";
				break;
			}
